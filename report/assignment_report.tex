...
\subsubsection{SAP2000 Model --- Settlement Case (Q2a)}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{q2a_structure.png}
    \caption{SAP2000 structural model for the Settlement Case (Q2a). Shows geometry, member connectivity, support conditions, applied loads, and prescribed settlement at Node 5.}
    \label{fig:q2a_sap2000_model}
\end{figure}
...
\subsubsection{SAP2000 Model --- Thermal Case (Q2b)}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{q2b_structure.png}
    \caption{SAP2000 structural model for the Thermal Loading Case (Q2b). Shows geometry, member connectivity, support conditions, and applied thermal loads.}
    \label{fig:q2b_sap2000_model}
\end{figure}
